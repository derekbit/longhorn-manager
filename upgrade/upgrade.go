...
import (
	...
	"github.com/longhorn/longhorn-manager/upgrade/v180to181"
...
func doResourceUpgrade(namespace string, lhClient *lhclientset.Clientset, kubeClient *clientset.Clientset) (err error) {
	...
	if semver.Compare(lhVersionBeforeUpgrade, "v1.8.1") < 0 {
		logrus.Info("Walking through the resource upgrade path v1.8.0 to v1.8.1")
		if err := v180to181.UpgradeResources(namespace, lhClient, kubeClient, resourceMaps); err != nil {
			return err
		}
	}
