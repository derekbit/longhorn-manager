...
type BackupVolumeSpec struct {
	...
	// +kubebuilder:validation:XValidation:rule="self != ''",message="BackupTargetName cannot be empty"
	BackupTargetName string `json:"backupTargetName"`
	// The volume name that the backup volume was used to backup.
	// +kubebuilder:validation:XValidation:rule="self != ''",message="VolumeName cannot be empty"
