...
func (in *UpgradeStatus) DeepCopyInto(out *UpgradeStatus) {
	*out = *in
	if in.UpgradingVolumes != nil {
		in, out := &in.UpgradingVolumes, &out.UpgradingVolumes
		*out = make(map[string]*UpgradeVolumeInfo, len(*in))
		for key, val := range *in {
			var outVal *UpgradeVolumeInfo
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(UpgradeVolumeInfo)
				**out = **in
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpgradeVolumeInfo) DeepCopyInto(out *UpgradeVolumeInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpgradeVolumeInfo.
func (in *UpgradeVolumeInfo) DeepCopy() *UpgradeVolumeInfo {
	if in == nil {
		return nil
	}
	out := new(UpgradeVolumeInfo)
