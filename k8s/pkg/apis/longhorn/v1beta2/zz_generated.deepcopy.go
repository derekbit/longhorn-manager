...
func (in *UpgradeStatus) DeepCopyInto(out *UpgradeStatus) {
	*out = *in
	if in.Volumes != nil {
		...
		*out = make(map[string]*UpgradedVolumeInfo, len(*in))
		for key, val := range *in {
			var outVal *UpgradedVolumeInfo
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(UpgradedVolumeInfo)
				**out = **in
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpgradedVolumeInfo) DeepCopyInto(out *UpgradedVolumeInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpgradedVolumeInfo.
func (in *UpgradedVolumeInfo) DeepCopy() *UpgradedVolumeInfo {
	if in == nil {
		return nil
	}
	out := new(UpgradedVolumeInfo)
