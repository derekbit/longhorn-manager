...
func (c *ProxyClient) SnapshotBackup(engineName, serviceAddress, backendStoreDriver, backupName, snapshotName, backupTarget,
...
func (c *ProxyClient) SnapshotBackupStatus(engineName, serviceAddress, backendStoreDriver, backupName, replicaAddress string) (status *SnapshotBackupStatus, err error) {
	input := map[string]string{
		"engineName":     engineName,
		"serviceAddress": serviceAddress,
		"backendStore":   backendStoreDriver,
...
func (c *ProxyClient) BackupRestore(engineName, serviceAddress, backendStoreDriver, url, target, volumeName string, envs []string, concurrentLimit int) (err error) {
	input := map[string]string{
		"engineName":     engineName,
		"serviceAddress": serviceAddress,
		"backendStore":   backendStoreDriver,
...
func (c *ProxyClient) BackupRestoreStatus(engineName, serviceAddress, backendStoreDriver string) (status map[string]*BackupRestoreStatus, err error) {
	input := map[string]string{
		"engineName":     engineName,
		"serviceAddress": serviceAddress,
		"backendStore":   backendStoreDriver,
