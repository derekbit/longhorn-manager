...
func (m *VolumeManager) trimNonRWXVolumeFilesystem(volumeName string, isEncryptedDevice bool) error {
	return util.TrimFilesystem(volumeName, isEncryptedDevice)
}

func (m *VolumeManager) trimRWXVolumeFilesystem(volumeName string, isEncryptedDevice bool) error {
	...
	return client.FilesystemTrim(isEncryptedDevice)
}
