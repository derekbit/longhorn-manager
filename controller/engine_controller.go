...
func (ec *EngineController) GetInstance(obj interface{}) (*longhorn.InstanceProcess, error) {
	...
	return c.InstanceGet(e.Name, string(longhorn.InstanceManagerTypeEngine), e.Spec.BackendStoreDriver, "")
}
...
func (ec *EngineController) LogInstance(ctx context.Context, obj interface{}) (*engineapi.InstanceManagerClient, *imapi.LogStream, error) {
	...
	stream, err := c.InstanceLog(ctx, e.Name, string(longhorn.InstanceManagerTypeEngine), e.Spec.BackendStoreDriver)
	return c, stream, err
}
...
func (ec *EngineController) UpgradeEngineProcess(e *longhorn.Engine, log *logrus.Entry) error {
	...
	processBinary, err := c.InstanceGetBinary(e.Name, string(longhorn.InstanceManagerTypeEngine), e.Spec.BackendStoreDriver, "")
	if err != nil {
