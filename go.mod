...
require (
	...
	github.com/longhorn/backing-image-manager v1.12.0-dev-20260308
	...
	github.com/longhorn/longhorn-instance-manager v1.12.0-dev-20260308
	github.com/longhorn/longhorn-share-manager v1.12.0-dev-20260308
