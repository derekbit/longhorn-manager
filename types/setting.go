...
var (
	...
	SettingDefinitionFastReplicaRebuildEnabled = SettingDefinition{
		...
		Description: "This setting enables the fast replica rebuilding feature. The feature relies on the checksums of snapshot disk files, so setting **snapshot-data-integrity** to **enable** or **fast-check** is a prerequisite.",
		Category:    SettingCategoryGeneral,
		Type:        SettingTypeBool,
		Required:    true,
		ReadOnly:    false,
