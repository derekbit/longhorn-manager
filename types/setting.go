...
const (
	...
	SettingNameSpdkTgtLogLevel                                          = SettingName("spdk-tgt-log-level")
	SettingNameSpdkTgtLogFlags                                          = SettingName("spdk-tgt-log-flags")
...
var (
	SettingNameList = []SettingName{
		...
		SettingNameCPUMask,
		SettingNameSpdkTgtLogLevel,
		SettingNameSpdkTgtLogFlags,
		SettingNameSnapshotDataIntegrity,
...
var replacedSettingNames = map[SettingName]bool{
	...
	SettingNameV2DataEngineLogLevel:                     true, // SettingNameSpdkTgtLogLevel
	SettingNameV2DataEngineLogFlags:                     true, // SettingNameSpdkTgtLogFlags
...
type SettingDefinition struct {
	...
	DataEngineSpecific bool     `json:"dataEngineSpecific,omitempty"`
...
var (
	settingDefinitions = map[SettingName]SettingDefinition{
		...
		SettingNameSpdkTgtLogLevel:                                          SettingDefinitionSpdkTgtLogLevel,
		SettingNameSpdkTgtLogFlags:                                          SettingDefinitionSpdkTgtLogFlags,
	...
	SettingDefinitionEngineReplicaTimeout = SettingDefinition{
		...
		ReadOnly:           false,
		DataEngineSpecific: true,
		Default:            fmt.Sprintf("{%q: \"8\"}", longhorn.DataEngineTypeV1),
		ValueIntRange: map[string]int{
	...
	SettingDefinitionSpdkTgtLogLevel = SettingDefinition{
		DisplayName:        "SPDK Target Daemon Log Level",
	...
	SettingDefinitionSpdkTgtLogFlags = SettingDefinition{
		DisplayName:        "SPDK Target Daemon Log Flags",
