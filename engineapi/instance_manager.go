...
func (c *InstanceManagerClient) InstanceDelete(obj interface{}) error {
...
func (c *InstanceManagerClient) InstanceGet(obj interface{}) (*longhorn.InstanceProcess, error) {
	if err := CheckInstanceManagerCompatibility(c.apiMinVersion, c.apiVersion); err != nil {
		return nil, err
	}
	...
	runtimeObj, ok := obj.(runtime.Object)
	if !ok {
		return nil, fmt.Errorf("obj is not a runtime.Object: %v", obj)
	}
...
func (c *InstanceManagerClient) InstanceLog(ctx context.Context, obj interface{}) (*imapi.LogStream, error) {
	if err := CheckInstanceManagerCompatibility(c.apiMinVersion, c.apiVersion); err != nil {
		return nil, err
	}
...
func (c *InstanceManagerClient) InstanceList(imType longhorn.InstanceManagerType) (map[string]longhorn.InstanceProcess, error) {
	...
	if imType == longhorn.InstanceManagerTypeReplica {
		// List all the lvols
