...
func (c *InstanceManagerClient) EngineProcessCreate(engineName, volumeName string, volumeSize int64, engineImage string, volumeFrontend longhorn.VolumeFrontend, replicaAddressMap map[string]string, revCounterDisabled bool, salvageRequested bool) (*longhorn.InstanceProcess, error) {
